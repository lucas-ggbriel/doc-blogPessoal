                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-6f66466de35fe99b491f2aa6f790b1d2"' : 'data-target="#xs-components-links-module-AppModule-6f66466de35fe99b491f2aa6f790b1d2"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-6f66466de35fe99b491f2aa6f790b1d2"' :
                                            'id="xs-components-links-module-AppModule-6f66466de35fe99b491f2aa6f790b1d2"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/DelecaoComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">DelecaoComponent</a>
                                            </li>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/Postagens.html" data-type="entity-link">Postagens</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/AutenticacaoService.html" data-type="entity-link">AutenticacaoService</a>
                                </li>
                                <li class="link">
